...
public sealed class ConversationServiceTest
{
    ...
    // private readonly IConnectionService _sut;
    ...
    //     _sut = new ConnectionService(_unitOfWorkMock.Object, _userServiceMock.Object);
    // }
    //
    // [Fact]
    ...
    //     // Act.
    //     var result = await _sut.GetUserConnectionIdsAsync(default);
    //
    //     // Assert.
    ...
    //     // Act.
    //     var result = await _sut.GetOrCreateDialogAsync(newDialogDto);
    //
    //     // Assert.
    //     using (new AssertionScope())
    //     {
